...
-- user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status)
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Esha', 'Sah', 'e.sah@g.com', 'Washington Street', 'San Jose', '95112', 'pass@1234$', 1, 'confirmed');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('John', 'Smith', 'j.smi@g.com', 'Saint James Street', 'San Jose', '95101', 'pass@1234$', 0,'cancelled');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Melissa', 'Jones', 'mj@g.com', 'Cahill Street', 'San Jose', '95106', 'pass@1234$', 0, 'confirmed');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Amit', 'Singh', 'am.singh@g.com', 'Almaden Blvd', 'San Jose', '95110', 'pass@1234$', 0, 'confirmed');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Peter', 'Parker', 'spidey@g.com', 'North 6th Street', 'San Jose', '95112', 'pass@1234$', 0, 'confirmed');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Radhika', 'Salins', 'rd.s@g.com', 'Julian Street', 'San Jose', '95110', 'pass@1234$', 0, 'confirmed');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Monica', 'Rao', 'moni@g.com', 'Reed Street', 'San Jose', '95113', 'pass@1234$', 0, 'pending');
insert into user (f_name, l_name, email_id, street, city, zip_code, password, is_admin, status) values('Deam', 'Thomas', 'dean@g.com', 'North 6th Street', 'San Jose', '95112', 'pass@1234$', 0, 'pending');
...
-- member (user_id, membership_type, start_date, end_date, status)
insert into member values(1002, 'gold', '2019-05-01', '2020-04-30', 'cancelled');
insert into member values(1003, 'gold', '2021-01-01', '2021-12-31', 'confirmed');
insert into member values(1004, 'platinum', '2021-04-05', '2022-04-04', 'confirmed');
insert into member values(1005, 'silver', '2020-10-17', '2021-10-16', 'confirmed');
insert into member values(1006, 'platinum', '2021-04-17', '2022-04-16', 'confirmed');
insert into member values(1007, 'gold', '2021-04-17', '2022-04-16', 'pending');
insert into member values(1008, 'platinum', '2021-02-01', '2022-01-31','pending');
