const SQL_USER = {
    ...
    GET_EVENTS_LIST: "select e.event_id,e.event_name,DATE_FORMAT(e.start_date,'%Y-%m-%d') as 'start_date',DATE_FORMAT(e.end_date,'%Y-%m-%d') as end_date,e.status,(e.capacity-e.no_of_participants) as capacity,v.venue_name from events e join venue v on e.venue_id = v.venue_id;",
